...
pub fn secp256k1_fe_sqr_inner(r: &mut [u64; 5], a: &[u64; 5]) {
    let mut c: u128;
    let mut d: u128;
    let t3: u64;
    let mut t4: u64;
    ...
    d += (a0 as u128) * (a4 as u128)
        + ((a1 as u128) * 2) * (a3 as u128)
        + (a2 as u128) * (a2 as u128);

    d += ((R as u128) << 12 as u128) * (c as u64 as u128);
    ...
    c += (a0 as u128 * a2 as u128) + (a1 as u128 * a1 as u128);
