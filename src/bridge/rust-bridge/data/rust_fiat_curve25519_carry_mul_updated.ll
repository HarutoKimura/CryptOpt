; ModuleID = 'rust_fiat_curve25519_carry_mul.fa7678d88e318ec8-cgu.0'
source_filename = "rust_fiat_curve25519_carry_mul.fa7678d88e318ec8-cgu.0"
...
start:
  ...
  %_0.i1 = getelementptr inbounds i8, ptr %arg2, i64 32
  %_10 = load i64, ptr %_0.i1, align 8, !noundef !3
  %_9 = mul i64 %_10, 19
  %_8 = zext i64 %_9 to i128
  %x1 = mul nuw i128 %_8, %_5
  %_0.i3 = getelementptr inbounds i8, ptr %arg2, i64 24
  ...
  %_0.i7 = getelementptr inbounds i8, ptr %arg2, i64 8
  %_34 = load i64, ptr %_0.i7, align 8, !noundef !3
  %_33 = mul i64 %_34, 19
  %_32 = zext i64 %_33 to i128
  %x4 = mul nuw i128 %_32, %_5
  %_0.i8 = getelementptr inbounds i8, ptr %arg1, i64 24
  ...
  %_0.i51 = getelementptr inbounds i8, ptr %out1, i64 8
  store i64 %x51, ptr %_0.i51, align 8
  %_0.i52 = getelementptr inbounds i8, ptr %out1, i64 16
  store i64 %x52, ptr %_0.i52, align 8
  %_0.i53 = getelementptr inbounds i8, ptr %out1, i64 24
  store i64 %x41, ptr %_0.i53, align 8
  %_0.i54 = getelementptr inbounds i8, ptr %out1, i64 32
  store i64 %x44, ptr %_0.i54, align 8
  ret void
}
