; ModuleID = 'rust_fiat_curve25519_solinas_mul_small_two_carry.10d6fadec3362734-cgu.0'
source_filename = "rust_fiat_curve25519_solinas_mul_small_two_carry.10d6fadec3362734-cgu.0"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: inlinehint mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(argmem: readwrite) uwtable
define void @rust_fiat_curve25519_solinas_mul_small_two_carry(ptr noalias nocapture noundef writeonly align 8 dereferenceable(32) %out1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg2) unnamed_addr #0 {
start:
  ...
  %x2.i104 = trunc i128 %x1.i103 to i64
  ...
  %x2.i118 = trunc i128 %_7.i117 to i64
  %_14.i119 = lshr i128 %_7.i117, 64
  %x3.i120 = trunc i128 %_14.i119 to i64
  %x44 = add nuw i64 %x3.i120, %x3.i24
  store i64 %x37, ptr %out1, align 8
  %6 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 1
  store i64 %x2.i104, ptr %6, align 8
  %7 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 2
  store i64 %x2.i118, ptr %7, align 8
  %8 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 3
  store i64 %x44, ptr %8, align 8
  ret void
}
