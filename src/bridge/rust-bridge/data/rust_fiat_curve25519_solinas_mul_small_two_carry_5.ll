; ModuleID = 'rust_fiat_curve25519_solinas_mul_small_two_carry_5.31b4b5d7a7cdf16c-cgu.0'
source_filename = "rust_fiat_curve25519_solinas_mul_small_two_carry_5.31b4b5d7a7cdf16c-cgu.0"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: inlinehint mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(argmem: readwrite) uwtable
define void @rust_fiat_curve25519_solinas_mul_small_two_carry_5(ptr noalias nocapture noundef writeonly align 8 dereferenceable(32) %out1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg2) unnamed_addr #0 {
start:
  ...
  %_10.i102 = zext i64 %x1.i33 to i128
  ...
  %x2.i112 = trunc i128 %x1.i111 to i64
  %_14.i113 = lshr i128 %x1.i111, 64
  %6 = trunc i128 %_14.i113 to i64
  %x2.i118 = add i64 %x37, %6
  store i64 %x2.i112, ptr %out1, align 8
  %7 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 1
  store i64 %x2.i112, ptr %7, align 8
  %8 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 2
  store i64 %x2.i118, ptr %8, align 8
  %9 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 3
  store i64 %x2.i118, ptr %9, align 8
  ret void
}
