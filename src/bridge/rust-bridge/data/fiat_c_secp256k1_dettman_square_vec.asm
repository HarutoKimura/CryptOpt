	...
	.globl	c_fiat_secp256k1_dettman_square # -- Begin function c_fiat_secp256k1_dettman_square
	.p2align	4, 0x90
	.type	c_fiat_secp256k1_dettman_square,@function
c_fiat_secp256k1_dettman_square:        # @c_fiat_secp256k1_dettman_square
	.cfi_startproc
# %bb.0:
	push	rbp
