; ModuleID = 'rust_fiat_poly1305_mul.f25a2bbeb74a0682-cgu.0'
source_filename = "rust_fiat_poly1305_mul.f25a2bbeb74a0682-cgu.0"
...
start:
  ...
  %_0.i12 = getelementptr inbounds [3 x i64], ptr %out1, i64 0, i64 1
  store i64 %x27, ptr %_0.i12, align 8
  %_0.i13 = getelementptr inbounds [3 x i64], ptr %out1, i64 0, i64 2
  store i64 %x28, ptr %_0.i13, align 8
  ret void
}
