; ModuleID = 'rust_fiat_curve25519_carry_mul.7104760cd16cd687-cgu.0'
source_filename = "rust_fiat_curve25519_carry_mul.7104760cd16cd687-cgu.0"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: inlinehint mustprogress nofree norecurse nosync nounwind nonlazybind willreturn memory(argmem: readwrite) uwtable
define void @rust_fiat_curve25519_carry_mul(ptr noalias nocapture noundef writeonly align 8 dereferenceable(40) %out1, ptr noalias nocapture noundef readonly align 8 dereferenceable(40) %arg1, ptr noalias nocapture noundef readonly align 8 dereferenceable(40) %arg2) unnamed_addr #0 {
start:
  %_7 = getelementptr inbounds [5 x i64], ptr %arg1, i64 0, i64 4
  %_6 = load i64, ptr %_7, align 8, !noundef !3
  %_5 = zext i64 %_6 to i128
  %_11 = getelementptr inbounds [5 x i64], ptr %arg2, i64 0, i64 4
  %_10 = load i64, ptr %_11, align 8, !noundef !3
  %_9 = mul i64 %_10, 19
  %_8 = zext i64 %_9 to i128
  %x1 = mul nuw i128 %_8, %_5
  %_19 = getelementptr inbounds [5 x i64], ptr %arg2, i64 0, i64 3
  %_18 = load i64, ptr %_19, align 8, !noundef !3
  %_17 = mul i64 %_18, 19
  %_16 = zext i64 %_17 to i128
  %x2 = mul nuw i128 %_16, %_5
  %_27 = getelementptr inbounds [5 x i64], ptr %arg2, i64 0, i64 2
  %_26 = load i64, ptr %_27, align 8, !noundef !3
  %_25 = mul i64 %_26, 19
  %_24 = zext i64 %_25 to i128
  %x3 = mul nuw i128 %_24, %_5
  %_35 = getelementptr inbounds [5 x i64], ptr %arg2, i64 0, i64 1
  %_34 = load i64, ptr %_35, align 8, !noundef !3
  %_33 = mul i64 %_34, 19
  %_32 = zext i64 %_33 to i128
  %x4 = mul nuw i128 %_32, %_5
  %_39 = getelementptr inbounds [5 x i64], ptr %arg1, i64 0, i64 3
  %_38 = load i64, ptr %_39, align 8, !noundef !3
  %_37 = zext i64 %_38 to i128
  %x5 = mul nuw i128 %_37, %_8
  %x6 = mul nuw i128 %_37, %_16
  %x7 = mul nuw i128 %_37, %_24
  %_63 = getelementptr inbounds [5 x i64], ptr %arg1, i64 0, i64 2
  %_62 = load i64, ptr %_63, align 8, !noundef !3
  %_61 = zext i64 %_62 to i128
  %x8 = mul nuw i128 %_61, %_8
  %x9 = mul nuw i128 %_61, %_16
  %_79 = getelementptr inbounds [5 x i64], ptr %arg1, i64 0, i64 1
  %_78 = load i64, ptr %_79, align 8, !noundef !3
  ...
  %_248 = getelementptr inbounds [5 x i64], ptr %out1, i64 0, i64 1
  %_249 = getelementptr inbounds [5 x i64], ptr %out1, i64 0, i64 2
  %_250 = getelementptr inbounds [5 x i64], ptr %out1, i64 0, i64 3
  ...
  %3 = insertelement <2 x i128> poison, i128 %x39, i64 0
  %4 = insertelement <2 x i128> %3, i128 %x42, i64 1
  %5 = trunc <2 x i128> %4 to <2 x i64>
  %6 = and <2 x i64> %5, <i64 2251799813685247, i64 2251799813685247>
  %x45 = mul i64 %x43, 19
  %x46 = add i64 %x45, %x28
  %x47 = lshr i64 %x46, 51
  ...
  store i64 %x51, ptr %_248, align 8
  store i64 %x52, ptr %_249, align 8
  store <2 x i64> %6, ptr %_250, align 8
  ret void
}
