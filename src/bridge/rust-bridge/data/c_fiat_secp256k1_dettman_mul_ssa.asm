	...
	.globl	c_fiat_secp256k1_dettman_mul    # -- Begin function c_fiat_secp256k1_dettman_mul
	.p2align	4, 0x90
	.type	c_fiat_secp256k1_dettman_mul,@function
c_fiat_secp256k1_dettman_mul:           # @c_fiat_secp256k1_dettman_mul
	.cfi_startproc
# %bb.0:
	push	rbp
