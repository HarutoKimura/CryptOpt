...
define void @rust_fiat_curve25519_solinas_mul_small_two_carry_3(ptr noalias nocapture noundef writeonly align 8 dereferenceable(32) %out1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg2) unnamed_addr #0 {
start:
  ...
  %6 = trunc i128 %x1.i91 to i64
  %x2.i104 = add i64 %x1.i33, %6
  ...
  store i64 %x2.i104, ptr %8, align 8
  %9 = getelementptr inbounds [4 x i64], ptr %out1, i64 0, i64 3
  store i64 %x2.i104, ptr %9, align 8
  ret void
}
