	...
	.globl	c_fiat_poly1305_carry_mul       # -- Begin function c_fiat_poly1305_carry_mul
	.p2align	4, 0x90
	.type	c_fiat_poly1305_carry_mul,@function
c_fiat_poly1305_carry_mul:              # @c_fiat_poly1305_carry_mul
	.cfi_startproc
# %bb.0:
	push	rbp
