...
define void @rust_fiat_curve25519_solinas_mul_small_two_carry_4(ptr noalias nocapture noundef writeonly align 8 dereferenceable(32) %out1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg1, ptr noalias nocapture noundef readonly align 8 dereferenceable(32) %arg2) unnamed_addr #0 {
start:
  ...
  store i64 %x2.i112, ptr %8, align 8
  ret void
}
