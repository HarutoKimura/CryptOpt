import re
import sys
from operation_transformer import decompose_select, decompose_sext, negative_add_check, change_negative_add_to_sub
...
def process_llvm_ir(llvm_file, rust_functions, output_file):
    ...
    for line in lines:
        ...
        #     decompose = change_negative_add_to_sub(line)
        #     filtered_lines.append(decompose)
        #     continue
